...
int main(int argc, char* argv[])
{
  ...
  auto logger = rclcpp::get_logger("planning_around_objects");
  ...
  prompt("Press Next in the RvizVisualToolsGui window to plan around the table");
  draw_title("Planning Around Objects");
